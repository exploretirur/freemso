...
var HEADERS = [
  'Enquiry ID', 'Date & Time', 'Name', 'Address', 'Place',
...
function runTest() {
  var sheet = getSheet();
  sheet.appendRow([
    'TEST-0001', new Date().toLocaleString(), 'Test Student', 'Test Address',
    'Tirur', "'9999999999", 'test@example.com', 'Degree', 'B.Com', 'Test College'
  ]);
